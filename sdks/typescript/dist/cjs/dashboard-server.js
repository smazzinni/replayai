...
function startServer(opts) {
    ...
    if (storagePath) {
        (0, config_js_1.configure)({ storage: "local", storagePath });
    }
    const cfg = (0, config_js_1.getConfig)();
    const absStorage = (0, node_path_1.resolve)(cfg.storagePath);
    (0, node_fs_1.mkdirSync)((0, node_path_1.join)(absStorage, "sessions"), { recursive: true });
