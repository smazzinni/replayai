...
\`\`\`bash
node -e "console.log(require('@smazzinni/sdk').VERSION)"
# 0.4.1
\`\`\`
...
pip install "replayai-sdk[llama_index]"
pip install "replayai-sdk[crewai]"
\`\`\`
...
\`\`\`typescript
import { trace, withTrace } from "@smazzinni/sdk";
...
\`\`\`typescript
import { trace, recordStep } from "@smazzinni/sdk";
...
\`\`\`typescript
import { configure } from "@smazzinni/sdk";
...
jobs:
  test:
    ...
    steps:
      ...
      - run: pip install replayai-sdk pytest
